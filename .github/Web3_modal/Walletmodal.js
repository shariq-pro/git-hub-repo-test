...
import { faCancel, faClose, faCross, faExclamationTriangle, faSpinner } from "@fortawesome/free-solid-svg-icons";
    ...
    useEffect(()=>{
      ...
      useEffect(()=>{
        ...
        if(error){
          set_wallet_msg(null)
          const err=error
          set_wallet_msg("Error connecting, please retry!")  
        }
      },[error])
        ...
        <Tab.Container id="left-tabs-example "  defaultActiveKey="profile">
          <Row className="p-1 h-100" >
                  ...
                  <Row className="pt-4 text-center">
                    ...
                    <Col md={12}>
                        ...
                        <Col md={12} className="pt-2" >
                          {wallet_msg !== null ?
                          <> <span className="metamask_modal_subtext" style={{fontSize:'20px',color:'red'}} ><FontAwesomeIcon icon={faExclamationTriangle} style={{color:'red',fontSize:'25px'}} /> {wallet_msg}</span></>:
            ...
            <Container className="modal_inner_container pt-0">
                    ...
                    {wallet_msg !== null ?<>
                      <> 
                      <span className="metamask_modal_subtext" style={{fontSize:'20px',color:'red'}} ><FontAwesomeIcon icon={faExclamationTriangle} style={{color:'red',fontSize:'20px'}} /> {wallet_msg}</span>
                      </>
